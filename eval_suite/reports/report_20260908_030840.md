...
**Generated:** 2026-09-08 03:08:40 UTC  
**Verdict:** ❌ **1/3 PROJECT(S) FAILING**  
**Projects:** P1 100% | P3 100% | P4 90% (★2 boundary)
...
| **P4** | 90% (★2 boundary) | 70% | ⚠️  REGRESSION | 1 (p4-008) | `openai/gpt-oss-20b` |
...
|-------|-------|
| **Status** | ⚠️  REGRESSION |
| **Pass Rate** | 90% (★2 boundary) |
| **Threshold** | 70% |
| **Model** | `openai/gpt-oss-20b` |
| **Regressions** | 1 — p4-008 |
| **Fixed this run** | p4-010 |
