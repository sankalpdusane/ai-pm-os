...
**Generated:** 2026-09-14 04:40:14 UTC  
**Verdict:** ❌ **1/3 PROJECT(S) FAILING**  
**Projects:** P1 60% | P3 100% | P4 100% (★2 boundary)

## Consolidated Summary

| Project | Pass Rate | Threshold | Status | Regressions | Model |
|---------|-----------|-----------|--------|-------------|-------|
| **P1** | 60% | 80% | ❌ BELOW THRESHOLD | 4 (p1-007, p1-008, p1-009, p1-010) | `openai/gpt-oss-20b` |
...
| **Regressions** | 4 — p1-007, p1-008, p1-009, p1-010 |

### Failed Cases

| Case ID | Diff / Reason |
|---------|---------------|
| `p1-007` | runner error: RuntimeError: P1 API returned HTTP 429: {"error":"Too many requests. Please wait 60 seconds.","retryAfter":1261} |
| `p1-008` | runner error: RuntimeError: P1 API returned HTTP 429: {"error":"Too many requests. Please wait 60 seconds.","retryAfter":1217} |
| `p1-009` | runner error: RuntimeError: P1 API returned HTTP 429: {"error":"Too many requests. Please wait 60 seconds.","retryAfter":1195} |
| `p1-010` | runner error: RuntimeError: P1 API returned HTTP 429: {"error":"Too many requests. Please wait 60 seconds.","retryAfter":1174} |
